...
CsmCassiniyArea::CsmCassiniyArea()
{
	q = 3.0;
	a = 1.1;
	m_pModel = NULL;
...
bool CsmCassiniyArea::IsInArea(double x, double y)
{
...
void CsmCassiniyArea::OnResetCsm()
{
	a = atof(m_pCsmAreaCtrl->GetTxtBoxVal(1).c_str());
}

void CsmCassiniyArea::SetCsmAreaCtrl(ICsmAreaCtrl* pCsmAreaCtrl)
{
...
void CsmCassiniyArea::SetPoints(int n, nmc::Vector<POS> &commitment_point, nmc::Vector<POS> &wave_source_point)
{
...
void CsmCassiniyArea::DrawArea(int draw_mode)
{
	if(m_pModel){
